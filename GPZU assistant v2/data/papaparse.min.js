    ...
    (this._handle = null),
      ...
      (this.parseChunk = function (e, t) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          return (
            this._config.step || this._config.chunk || ((this._completeResults.data = this._completeResults.data.concat(n.data)), (this._completeResults.errors = this._completeResults.errors.concat(n.errors)), (this._completeResults.meta = n.meta)),
