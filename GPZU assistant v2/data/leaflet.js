...
!(function (t, e) {
  ...
  (p.prototype = {
    ...
    (s.prototype = {
      extend: function (t) {
        ...
        return (
          n || o ? ((n.lat = Math.min(e.lat, n.lat)), (n.lng = Math.min(e.lng, n.lng)), (o.lat = Math.max(i.lat, o.lat)), (o.lng = Math.max(i.lng, o.lng))) : ((this._southWest = new v(e.lat, e.lng)), (this._northEast = new v(i.lat, i.lng))), this
        );
      },
      pad: function (t) {
  ...
  var mt = {
    ...
    A = it.extend({
      ...
      panInside: function (t, e) {
        ...
        return (
          i.contains(t) ||
            ((this._enforcingBounds = !0), (n = t.subtract(i.getCenter())), (i = i.extend(t).getSize().subtract(s)), (o.x += n.x < 0 ? -i.x : i.x), (o.y += n.y < 0 ? -i.y : i.y), this.panTo(this.unproject(o), e), (this._enforcingBounds = !1)),
          this
        );
      },
      invalidateSize: function (t) {
        ...
        var e = this.getSize(),
          ...
          n = n.subtract(o);
        return n.x || n.y
          ? (t.animate && t.pan ? this.panBy(n) : (t.pan && this._rawPanBy(n), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), (this._sizeTimer = setTimeout(a(this.fire, this, "moveend"), 200))) : this.fire("moveend")),
  ...
  function oi(t, e, i, n, o) {
    var s,
      ...
      n = n.max;
    return (
      8 & i ? ((s = t.x + (a * (n.y - t.y)) / e), (r = n.y)) : 4 & i ? ((s = t.x + (a * (h.y - t.y)) / e), (r = h.y)) : 2 & i ? ((s = n.x), (r = t.y + (e * (n.x - t.x)) / a)) : 1 & i && ((s = h.x), (r = t.y + (e * (h.x - t.x)) / a)), new p(s, r, o)
    );
  }
  function si(t, e) {
    var i = 0;
    ...
    Ii =
      ...
      o.include({
        bindPopup: function (t, e) {
          return (
            (this._popup = this._initOverlay(Bi, this._popup, t, e)), this._popupHandlersAdded || (this.on({ click: this._openPopup, keypress: this._onKeyPress, remove: this.closePopup, move: this._movePopup }), (this._popupHandlersAdded = !0)), this
          );
        },
