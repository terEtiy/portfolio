  ...
  function rt(r, i) {
    ...
    function Lt(t) {
      if (!(Mt(t) || (E(st.props.trigger, "click") && U)))
        return st.props.interactive ? (G.body.addEventListener("mouseleave", Bt), G.addEventListener("mousemove", Y), I(et, Y), void Y(t)) : void Bt(t);
    }
    function kt(t) {
    ...
    function St() {
      ...
      function s(t) {
        ...
        (st.state.currentPlacement = t.placement),
          st.props.flip && !st.props.flipOnUpdate && (t.flipped && (st.popperInstance.options.placement = t.placement), d(st.popperInstance.modifiers, "flip", "enabled", !1)),
      ...
      var c = e({ eventsEnabled: !1, placement: st.props.placement }, i, {
        modifiers: e({}, i && i.modifiers, {
          ...
          flip: e({ enabled: st.props.flip, behavior: st.props.flipBehavior }, a),
