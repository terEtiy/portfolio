!(function (t, e) {
  ...
  const c =
    ...
    g = {
      ...
      _hex8ColorToRGBA(t) {
        if ("#" === t[0] && 9 === t.length) return { r: parseInt(t.slice(1, 3), 16), g: parseInt(t.slice(3, 5), 16), b: parseInt(t.slice(5, 7), 16), a: parseInt(t.slice(7, 9), 16) / 255 };
      },
      _hex6ColorToRGBA(t) {
        if ("#" === t[0] && 7 === t.length) return { r: parseInt(t.slice(1, 3), 16), g: parseInt(t.slice(3, 5), 16), b: parseInt(t.slice(5, 7), 16), a: 1 };
      },
      _hex4ColorToRGBA(t) {
        if ("#" === t[0] && 5 === t.length) return { r: parseInt(t[1] + t[1], 16), g: parseInt(t[2] + t[2], 16), b: parseInt(t[3] + t[3], 16), a: parseInt(t[4] + t[4], 16) / 255 };
      },
      _hex3ColorToRGBA(t) {
      ...
      drawRoundedRectPath(t, e, i, r) {
        let a = 0,
          ...
          s = 0,
          o = 0;
        "number" == typeof r ? (a = n = s = o = Math.min(r, e / 2, i / 2)) : ((a = Math.min(r[0] || 0, e / 2, i / 2)), (n = Math.min(r[1] || 0, e / 2, i / 2)), (o = Math.min(r[2] || 0, e / 2, i / 2)), (s = Math.min(r[3] || 0, e / 2, i / 2))),
          t.moveTo(a, 0),
          t.lineTo(e - n, 0),
  ...
  class P {
    ...
    getTrace(t, e) {
      ...
      for (i = 0; i < o; i++)
        (a = (r = s[i]).method)
          ? ((n = r.args), (h += a), t ? (h += "()") : g._isArray(n[0]) ? (h += "([" + n.join(",") + "])") : (e && (n = n.map((t) => ("number" == typeof t ? Math.floor(t) : t))), (h += "(" + n.join(",") + ")")))
      ...
      var e =
        ...
        (function () {
          ...
          var t = g.createCanvasElement(),
            e = t.getContext("2d");
          return (A = (i._global.devicePixelRatio || 1) / (e.webkitBackingStorePixelRatio || e.mozBackingStorePixelRatio || e.msBackingStorePixelRatio || e.oBackingStorePixelRatio || e.backingStorePixelRatio || 1)), g.releaseCanvas(t), A;
        })();
      (this.pixelRatio = e),
  ...
  class G extends M {
    constructor(t = { width: 0, height: 0, willReadFrequently: !1 }) {
      super(t), (this.context = new k(this, { willReadFrequently: t.willReadFrequently })), this.setSize(t.width, t.height);
    }
  }
  class R extends M {
    constructor(t = { width: 0, height: 0 }) {
      super(t), (this.hitCanvas = !0), (this.context = new T(this)), this.setSize(t.width, t.height);
    }
  }
  const E = {
    get isDragging() {
    ...
    _endDragAfter(t) {
      E._dragElements.forEach((e, i) => {
        "stopped" === e.dragStatus && e.node.fire("dragend", { type: "dragend", target: e.node, evt: t }, !0), "dragging" !== e.dragStatus && E._dragElements.delete(i);
      });
    },
  };
  i.isBrowser &&
  ...
  var D = "absoluteOpacity",
    ...
    X = "transform",
    j = "visible",
    q = ["xChange.konva", "yChange.konva", "scaleXChange.konva", "scaleYChange.konva", "skewXChange.konva", "skewYChange.konva", "rotationChange.konva", "offsetXChange.konva", "offsetYChange.konva", "transformsEnabledChange.konva"].join(z);
  let U = 1;
  class V {
    constructor(t) {
      (this._id = U++),
    ...
    _clearCache(t) {
      (t !== X && t !== I) || !this._cache.get(t) ? (t ? this._cache.delete(t) : this._cache.clear()) : (this._cache.get(t).dirty = !0);
    }
    _getCache(t, e) {
      var i = this._cache.get(t);
      return (void 0 === i || ((t === X || t === I) && !0 === i.dirty)) && ((i = e.call(this)), this._cache.set(t, i)), i;
    }
    _calculate(t, e, i) {
    ...
    cache(t) {
      var e = t || {},
        i = {};
      (void 0 !== e.x && void 0 !== e.y && void 0 !== e.width && void 0 !== e.height) || (i = this.getClientRect({ skipTransform: !0, relativeTo: this.getParent() || void 0 }));
      ...
      const c = Math.abs(Math.round(i.x) - s) > 0.5 ? 1 : 0,
        u = Math.abs(Math.round(i.y) - o) > 0.5 ? 1 : 0;
      (s -= h), (o -= h);
      var f = new G({ pixelRatio: n, width: (r += 2 * h + c), height: (a += 2 * h + u) }),
        p = new G({ pixelRatio: n, width: 0, height: 0, willReadFrequently: !0 }),
        v = new R({ pixelRatio: d, width: r, height: a }),
        m = f.getContext(),
        _ = v.getContext();
      return (
        (v.isCache = !0),
        ...
        (this._filterUpToDate = !1),
        !1 === e.imageSmoothingEnabled && ((f.getContext()._context.imageSmoothingEnabled = !1), (p.getContext()._context.imageSmoothingEnabled = !1)),
        m.save(),
        _.save(),
        m.translate(-s, -o),
        _.translate(-s, -o),
        ...
        m.restore(),
        _.restore(),
        l && (m.save(), m.beginPath(), m.rect(0, 0, r, a), m.closePath(), m.setAttr("strokeStyle", "red"), m.setAttr("lineWidth", 5), m.stroke(), m.restore()),
        this._cache.set(F, { scene: f, filter: p, hit: v, x: s, y: o }),
        this._requestDraw(),
        this
      );
    }
    ...
    _getCachedSceneCanvas() {
      ...
      if (a) {
        if (!this._filterUpToDate) {
          ...
          try {
            for (t = a.length, h.clear(), h.drawImage(s._canvas, 0, 0, s.getWidth() / l, s.getHeight() / l), e = h.getImageData(0, 0, o.getWidth(), o.getHeight()), i = 0; i < t; i++)
              "function" == typeof (r = a[i]) ? (r.call(this, e), h.putImageData(e, 0, 0)) : g.error("Filter should be type of function, but got " + typeof r + " instead. Please check correct filters");
          } catch (t) {
    ...
    on(t, e) {
      ...
      var i,
        ...
        s = t.split(z),
        o = s.length;
      for (i = 0; i < o; i++) (a = (r = s[i].split("."))[0]), (n = r[1] || ""), this.eventListeners[a] || (this.eventListeners[a] = []), this.eventListeners[a].push({ name: n, handler: e });
      return this;
    }
    off(t, e) {
      var i,
    ...
    _clearCaches() {
      this._clearSelfAndDescendantCache(I), this._clearSelfAndDescendantCache(D), this._clearSelfAndDescendantCache(O), this._clearSelfAndDescendantCache(Y), this._clearSelfAndDescendantCache(j), this._clearSelfAndDescendantCache(B);
    }
    _remove() {
      this._clearCaches();
    ...
    shouldDrawHit(t, e = !1) {
      ...
      var n = !e && !i.hitOnDragEnabled && (a || i.isTransforming());
    ...
    _batchTransformChanges(t) {
      (this._batchingTransformChange = !0), t(), (this._batchingTransformChange = !1), this._needClearTransformCache && (this._clearCache(X), this._clearSelfAndDescendantCache(I)), (this._needClearTransformCache = !1);
    }
    setPosition(t) {
      return (
        this._batchTransformChanges(() => {
    ...
    setAbsolutePosition(t) {
      ...
      return (
        a.invert(),
        a.translate(t.x, t.y),
        (t = { x: this.attrs.x + a.getTranslation().x, y: this.attrs.y + a.getTranslation().y }),
    ...
    _clearTransform() {
      var t = { x: this.x(), y: this.y(), rotation: this.rotation(), scaleX: this.scaleX(), scaleY: this.scaleY(), offsetX: this.offsetX(), offsetY: this.offsetY(), skewX: this.skewX(), skewY: this.skewY() };
    ...
    toObject() {
      var t,
        ...
        r,
        a = this.getAttrs();
      const n = { attrs: {}, className: this.getClassName() };
    ...
    _toKonvaCanvas(t) {
      ...
      var e = this.getClientRect(),
        ...
        n = t.pixelRatio || 1,
        s = new G({ width: t.width || Math.ceil(e.width) || (i ? i.width() : 0), height: t.height || Math.ceil(e.height) || (i ? i.height() : 0), pixelRatio: n }),
        o = s.getContext();
      const h = new G({ width: s.width / s.pixelRatio + Math.abs(r), height: s.height / s.pixelRatio + Math.abs(a), pixelRatio: s.pixelRatio });
    ...
    _fireAndBubble(t, e, i) {
      if ((e && this.nodeType === W && (e.target = this), !((t === N || t === H) && ((i && (this === i || (this.isAncestorOf && this.isAncestorOf(i)))) || ("Stage" === this.nodeType && !i))))) {
        this._fire(t, e);
        var r = (t === N || t === H) && i && i.isAncestorOf && i.isAncestorOf(this) && !i.isAncestorOf(this.parent);
    ...
    _createDragElement(t) {
      ...
      if (i) {
        ...
        E._dragElements.set(this._id, { node: this, startPointerPos: a, offset: { x: a.x - r.x, y: a.y - r.y }, dragStatus: "ready", pointerId: e });
      }
    }
    startDrag(t, e = !0) {
      E._dragElements.has(this._id) || this._createDragElement(t);
      (E._dragElements.get(this._id).dragStatus = "dragging"), this.fire("dragstart", { type: "dragstart", target: this, evt: t && t.evt }, e);
    }
    ...
    static _createNode(t, e) {
      var r,
        a,
        n,
        s = V.prototype.getClassName.call(t),
        o = t.children;
      e && (t.attrs.container = e), i[s] || (g.warn('Can not find a node with class name "' + s + '". Fallback to "Shape".'), (s = "Shape"));
      if (((r = new (0, i[s])(t.attrs)), o)) for (a = o.length, n = 0; n < a; n++) r.add(V._createNode(o[n]));
      return r;
    }
  }
  (V.prototype.nodeType = "Node"),
    ...
    V.prototype.on.call(V.prototype, q, function () {
      this._batchingTransformChange ? (this._needClearTransformCache = !0) : (this._clearCache(X), this._clearSelfAndDescendantCache(I));
    }),
  ...
  K(V, "zIndex"),
    ...
    K(V, "x", 0, p()),
    K(V, "y", 0, p()),
    K(V, "globalCompositeOperation", "source-over", _()),
    K(V, "opacity", 1, p()),
    K(V, "name", "", _()),
    K(V, "id", "", _()),
    K(V, "rotation", 0, p()),
    ...
    K(V, "offsetX", 0, p()),
    K(V, "offsetY", 0, p()),
    K(V, "dragDistance", null, p()),
    K(V, "width", 0, p()),
    K(V, "height", 0, p()),
    K(V, "listening", !0, x()),
    K(V, "preventDefault", !0, x()),
    K(V, "filters", null, function (t) {
      return (this._filterUpToDate = !1), t;
    }),
    K(V, "visible", !0, x()),
    K(V, "transformsEnabled", "all", _()),
    K(V, "size"),
    K(V, "dragBoundFunc"),
    K(V, "draggable", !1, x()),
  ...
  class Q extends V {
    ...
    _drawChildren(t, e, i, r) {
      ...
      p && (n.save(), n._applyGlobalCompositeOperation(this)),
        null === (a = this.children) ||
          void 0 === a ||
    ...
    getClientRect(t = {}) {
        ...
        e.forEach(function (e) {
          if (e.visible()) {
            ...
            (0 === s.width && 0 === s.height) ||
              (void 0 === i ? ((i = s.x), (r = s.y), (a = s.x + s.width), (n = s.y + s.height)) : ((i = Math.min(i, s.x)), (r = Math.min(r, s.y)), (a = Math.max(a, s.x + s.width)), (n = Math.max(n, s.y + s.height))));
          }
        });
      ...
      return (h = c && void 0 !== i ? { x: i, y: r, width: a - i, height: n - r } : { x: 0, y: 0, width: 0, height: 0 }), s ? h : this._transformedRect(h, o);
    }
  }
  ...
  const Pt = {
      mouse: { [ft]: "mouseout", [pt]: at, [vt]: nt, [mt]: st, [dt]: ot, [ct]: ht, [gt]: lt, [ut]: "mousecancel", pointerclick: "click", pointerdblclick: "dblclick" },
      touch: { [ft]: "touchout", [pt]: "touchleave", [vt]: "touchover", [mt]: "touchenter", [dt]: bt, [ct]: yt, [gt]: xt, [ut]: St, pointerclick: "tap", pointerdblclick: "dbltap" },
      pointer: { [ft]: ft, [pt]: pt, [vt]: vt, [mt]: mt, [dt]: dt, [ct]: ct, [gt]: gt, [ut]: ut, pointerclick: "pointerclick", pointerdblclick: "pointerdblclick" },
    },
  ...
  class Gt extends Q {
    ...
    getPointerPosition() {
      ...
      return t ? { x: t.x, y: t.y } : (g.warn("Pointer position is missing and not registered by the stage. Looks like it is outside of the stage container. You can set it manually from event: stage.setPointersPositions(event);"), null);
    }
    _getPointerById(t) {
    ...
    _toKonvaCanvas(t) {
      ...
      var e = new G({ width: t.width, height: t.height, pixelRatio: t.pixelRatio || 1 }),
    ...
    add(t, ...e) {
      ...
      return (
        a > 5 && g.warn("The stage has " + a + " layers. Recommended maximum number of layers is 3-5. Adding more layers into the stage may drop the performance. Rethink your tree structure, you can use Konva.Group."),
    ...
    _pointerleave(t) {
      ...
      if (e) {
        ...
        var a = this._getTargetShape(r),
          n = !(i.isDragging() || i.isTransforming()) || i.hitOnDragEnabled;
        a && n
          ? (a._fireAndBubble(e.pointerout, { evt: t }), a._fireAndBubble(e.pointerleave, { evt: t }), this._fire(e.pointerleave, { evt: t, target: this, currentTarget: this }), (this[r + "targetShape"] = null))
          : n && (this._fire(e.pointerleave, { evt: t, target: this, currentTarget: this }), this._fire(e.pointerout, { evt: t, target: this, currentTarget: this })),
    ...
    _pointerdown(t) {
      ...
      if (e) {
        ...
        this._changedPointerPositions.forEach((n) => {
          ...
          if (((E.justDragged = !1), (i["_" + r + "ListenClick"] = !0), !s || !s.isListening())) return void (this[r + "ClickStartShape"] = void 0);
          i.capturePointerEventsEnabled && s.setPointerCapture(n.id), (this[r + "ClickStartShape"] = s), s._fireAndBubble(e.pointerdown, { evt: t, pointerId: n.id }), (a = !0);
    ...
    _pointermove(t) {
      const e = Tt(t.type),
        r = kt(t.type);
      if (!e) return;
      if ((i.isDragging() && E.node.preventDefault() && t.cancelable && t.preventDefault(), this.setPointersPositions(t), !(!(i.isDragging() || i.isTransforming()) || i.hitOnDragEnabled))) return;
      var a = {};
      let n = !1;
      ...
      this._changedPointerPositions.forEach((i) => {
        ...
        o && o.isListening()
          ? ((n = !0), d && (o._fireAndBubble(e.pointerover, { ...l }, s), o._fireAndBubble(e.pointerenter, { ...l }, s), (this[r + "targetShape"] = o)), o._fireAndBubble(e.pointermove, { ...l }))
    ...
    _pointerup(t) {
      ...
      this._changedPointerPositions.forEach((h) => {
        ...
        const d = h.id,
          c = { evt: t, pointerId: d };
        let g = !1;
        i["_" + r + "InDblClickWindow"] ? ((g = !0), clearTimeout(this[r + "DblTimeout"])) : E.justDragged || ((i["_" + r + "InDblClickWindow"] = !0), clearTimeout(this[r + "DblTimeout"])),
          ...
          l && l.isListening()
            ? ((o = !0),
              ...
              i["_" + r + "ListenClick"] && a && a === l && (l._fireAndBubble(e.pointerclick, { ...c }), g && n && n === l && l._fireAndBubble(e.pointerdblclick, { ...c })))
    ...
    _contextmenu(t) {
      ...
      e && e.isListening() ? e._fireAndBubble(_t, { evt: t }) : this._fire(_t, { evt: t, target: this, currentTarget: this });
    }
    _wheel(t) {
      this.setPointersPositions(t);
      var e = this.getIntersection(this.getPointerPosition());
      e && e.isListening() ? e._fireAndBubble(wt, { evt: t }) : this._fire(wt, { evt: t, target: this, currentTarget: this });
    }
    _pointercancel(t) {
      this.setPointersPositions(t);
    ...
    _buildDOM() {
      if (((this.bufferCanvas = new G({ width: this.width(), height: this.height() })), (this.bufferHitCanvas = new R({ pixelRatio: 1, width: this.width(), height: this.height() })), i.isBrowser)) {
  ...
  class Nt extends V {
    ...
    __getFillPattern() {
      if (this.fillPatternImage()) {
        ...
        if (t && t.setTransform) {
          ...
          const r = e.getMatrix(),
            n = "undefined" == typeof DOMMatrix ? { a: r[0], b: r[1], c: r[2], d: r[3], e: r[4], f: r[5] } : new DOMMatrix(r);
          t.setTransform(n);
        }
        return t;
      }
    ...
    __getRadialGradient() {
      ...
      if (t) {
        for (
          var e = Ft(), i = this.fillRadialGradientStartPoint(), r = this.fillRadialGradientEndPoint(), a = e.createRadialGradient(i.x, i.y, this.fillRadialGradientStartRadius(), r.x, r.y, this.fillRadialGradientEndRadius()), n = 0;
          n < t.length;
          n += 2
        )
    ...
    getClientRect(t = {}) {
      ...
      const r = t.skipTransform,
        ...
        p = { width: g + 2 * f, height: u + 2 * f, x: -(s / 2 + f) + Math.min(d, 0) + n.x, y: -(s / 2 + f) + Math.min(c, 0) + n.y };
  ...
  (Nt.prototype._fillFunc = function (t) {
    ...
    Nt.prototype.on.call(Nt.prototype, "shadowColorChange.konva shadowBlurChange.konva shadowOffsetChange.konva shadowOpacityChange.konva shadowEnabledChange.konva", function () {
      this._clearCache(Rt);
    }),
    Nt.prototype.on.call(Nt.prototype, "shadowColorChange.konva shadowOpacityChange.konva shadowEnabledChange.konva", function () {
      this._clearCache(Et);
    }),
    ...
    w.addGetterSetter(Nt, "shadowColor", void 0, _()),
    ...
    w.addGetterSetter(Nt, "fill", void 0, y()),
    ...
    w.addGetterSetter(Nt, "fillRule", void 0, _()),
    w.backCompat(Nt, {
      dashArray: "dash",
  ...
  class zt extends Q {
    ...
    setZIndex(t) {
      ...
      return (
        e &&
          e.content &&
          (e.content.removeChild(this.getNativeCanvasElement()), t < e.children.length - 1 ? e.content.insertBefore(this.getNativeCanvasElement(), e.children[t + 1].getCanvas()._canvas) : e.content.appendChild(this.getNativeCanvasElement())),
        this
      );
    }
    moveToTop() {
    ...
    drawScene(t, e) {
      var i = this.getLayer(),
        r = t || (i && i.getCanvas());
      return this._fire("beforeDraw", { node: this }), this.clearBeforeDraw() && r.getContext().clear(), Q.prototype.drawScene.call(this, r, e), this._fire("draw", { node: this }), this;
    }
    drawHit(t, e) {
      var i = this.getLayer(),
        r = t || (i && i.hitCanvas);
  ...
  class qt {
    constructor(t, e) {
      (this.id = qt.animIdCounter++), (this.frame = { time: 0, timeDiff: 0, lastTime: jt(), frameRate: 0 }), (this.func = t), this.setLayers(e);
    }
    setLayers(t) {
      let e = [];
  ...
  class Jt {
    constructor(t) {
      var e,
        ...
        o = t.easing || $t.Linear,
        h = !!t.yoyo;
      (e = void 0 === t.duration ? 0.3 : 0 === t.duration ? 0.001 : t.duration), (this.node = n), (this._id = Vt++);
    ...
    _addAttr(t, e) {
      ...
      if (((a = Jt.tweens[c][t]) && delete Jt.attrs[c][a][t], (i = d.getAttr(t)), g._isArray(e)))
        if (
          ...
          "points" === t && e.length !== i.length && (e.length > i.length ? ((h = i), (i = g._prepareArrayForTween(i, e, d.closed()))) : ((o = e), (e = g._prepareArrayForTween(e, i, d.closed())))),
          0 === t.indexOf("fill"))
        )
          for (n = 0; n < s; n++)
      ...
      else -1 !== Kt.indexOf(t) ? ((i = g.colorToRGBA(i)), (r = { r: (l = g.colorToRGBA(e)).r - i.r, g: l.g - i.g, b: l.b - i.b, a: l.a - i.a })) : (r = e - i);
      (Jt.attrs[c][this._id][t] = { start: i, diff: r, end: e, trueEnd: o, trueStart: h }), (Jt.tweens[c][t] = this._id);
    }
    _tweenFunc(t) {
      var e,
        i,
  ...
  const $t = {
      ...
      ElasticEaseOut(t, e, i, r, a, n) {
        var s = 0;
        return 0 === t ? e : 1 == (t /= r) ? e + i : (n || (n = 0.3 * r), !a || a < Math.abs(i) ? ((a = i), (s = n / 4)) : (s = (n / (2 * Math.PI)) * Math.asin(i / a)), a * Math.pow(2, -10 * t) * Math.sin(((t * r - s) * (2 * Math.PI)) / n) + i + e);
      },
      ElasticEaseInOut(t, e, i, r, a, n) {
        ...
        return 0 === t
          ...
          ? e + i
          : (n || (n = r * (0.3 * 1.5)),
            !a || a < Math.abs(i) ? ((a = i), (s = n / 4)) : (s = (n / (2 * Math.PI)) * Math.asin(i / a)),
            t < 1 ? a * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t * r - s) * (2 * Math.PI)) / n) * -0.5 + e : a * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t * r - s) * (2 * Math.PI)) / n) * 0.5 + i + e);
      },
      BounceEaseOut: (t, e, i, r) =>
        (t /= r) < 1 / 2.75 ? i * (7.5625 * t * t) + e : t < 2 / 2.75 ? i * (7.5625 * (t -= 1.5 / 2.75) * t + 0.75) + e : t < 2.5 / 2.75 ? i * (7.5625 * (t -= 2.25 / 2.75) * t + 0.9375) + e : i * (7.5625 * (t -= 2.625 / 2.75) * t + 0.984375) + e,
      BounceEaseIn: (t, e, i, r) => i - $t.BounceEaseOut(r - t, 0, i, r) + e,
      BounceEaseInOut: (t, e, i, r) => (t < r / 2 ? 0.5 * $t.BounceEaseIn(2 * t, 0, i, r) + e : 0.5 * $t.BounceEaseOut(2 * t - r, 0, i, r) + 0.5 * i + e),
    ...
    Zt = g._assign(i, { Util: g, Transform: a, Node: V, Container: Q, Stage: Gt, stages: Mt, Layer: zt, FastLayer: Yt, Group: Xt, DD: E, Shape: Nt, shapes: Bt, Animation: qt, Tween: Jt, Easings: $t, Context: P, Canvas: M });
  class te extends Nt {
    _sceneFunc(t) {
  ...
  class re extends Nt {
    ...
    getSelfRect() {
      ...
      for (var e, i, r = (t = 0 !== this.tension() ? [t[0], t[1], ...this._getTensionPoints(), t[t.length - 2], t[t.length - 1]] : this.points())[0], a = t[0], n = t[1], s = t[1], o = 0; o < t.length / 2; o++)
  ...
  const ae = [
      ...
      [
        -0.1252334085114689, 0.1252334085114689, -0.3678314989981802, 0.3678314989981802, -0.5873179542866175, 0.5873179542866175, -0.7699026741943047, 0.7699026741943047, -0.9041172563704749, 0.9041172563704749, -0.9815606342467192,
        0.9815606342467192,
      ],
      [
        0, -0.2304583159551348, 0.2304583159551348, -0.44849275103644687, 0.44849275103644687, -0.6423493394403402, 0.6423493394403402, -0.8015780907333099, 0.8015780907333099, -0.9175983992229779, 0.9175983992229779, -0.9841830547185881,
        0.9841830547185881,
      ],
      [
        -0.10805494870734367, 0.10805494870734367, -0.31911236892788974, 0.31911236892788974, -0.5152486363581541, 0.5152486363581541, -0.6872929048116855, 0.6872929048116855, -0.827201315069765, 0.827201315069765, -0.9284348836635735,
        0.9284348836635735, -0.9862838086968123, 0.9862838086968123,
      ],
      [
        0, -0.20119409399743451, 0.20119409399743451, -0.3941513470775634, 0.3941513470775634, -0.5709721726085388, 0.5709721726085388, -0.7244177313601701, 0.7244177313601701, -0.8482065834104272, 0.8482065834104272, -0.937273392400706,
        0.937273392400706, -0.9879925180204854, 0.9879925180204854,
      ],
      [
        -0.09501250983763744, 0.09501250983763744, -0.2816035507792589, 0.2816035507792589, -0.45801677765722737, 0.45801677765722737, -0.6178762444026438, 0.6178762444026438, -0.755404408355003, 0.755404408355003, -0.8656312023878318,
        0.8656312023878318, -0.9445750230732326, 0.9445750230732326, -0.9894009349916499, 0.9894009349916499,
      ],
      [
        0, -0.17848418149584785, 0.17848418149584785, -0.3512317634538763, 0.3512317634538763, -0.5126905370864769, 0.5126905370864769, -0.6576711592166907, 0.6576711592166907, -0.7815140038968014, 0.7815140038968014, -0.8802391537269859,
        0.8802391537269859, -0.9506755217687678, 0.9506755217687678, -0.9905754753144174, 0.9905754753144174,
      ],
      [
        -0.0847750130417353, 0.0847750130417353, -0.2518862256915055, 0.2518862256915055, -0.41175116146284263, 0.41175116146284263, -0.5597708310739475, 0.5597708310739475, -0.6916870430603532, 0.6916870430603532, -0.8037049589725231,
        0.8037049589725231, -0.8926024664975557, 0.8926024664975557, -0.9558239495713977, 0.9558239495713977, -0.9915651684209309, 0.9915651684209309,
      ],
      [
        0, -0.16035864564022537, 0.16035864564022537, -0.31656409996362983, 0.31656409996362983, -0.46457074137596094, 0.46457074137596094, -0.600545304661681, 0.600545304661681, -0.7209661773352294, 0.7209661773352294, -0.8227146565371428,
        0.8227146565371428, -0.9031559036148179, 0.9031559036148179, -0.96020815213483, 0.96020815213483, -0.9924068438435844, 0.9924068438435844,
      ],
      [
        ...
        0.7463319064601508, -0.8391169718222188, 0.8391169718222188, -0.912234428251326, 0.912234428251326, -0.9639719272779138, 0.9639719272779138, -0.9931285991850949, 0.9931285991850949,
      ],
      [
        0, -0.1455618541608951, 0.1455618541608951, -0.2880213168024011, 0.2880213168024011, -0.4243421202074388, 0.4243421202074388, -0.5516188358872198, 0.5516188358872198, -0.6671388041974123, 0.6671388041974123, -0.7684399634756779,
        0.7684399634756779, -0.8533633645833173, 0.8533633645833173, -0.9200993341504008, 0.9200993341504008, -0.9672268385663063, 0.9672268385663063, -0.9937521706203895, 0.9937521706203895,
      ],
      [
        -0.06973927331972223, 0.06973927331972223, -0.20786042668822127, 0.20786042668822127, -0.34193582089208424, 0.34193582089208424, -0.469355837986757, 0.469355837986757, -0.5876404035069116, 0.5876404035069116, -0.6944872631866827,
        0.6944872631866827, -0.7878168059792081, 0.7878168059792081, -0.8658125777203002, 0.8658125777203002, -0.926956772187174, 0.926956772187174, -0.9700604978354287, 0.9700604978354287, -0.9942945854823992, 0.9942945854823992,
      ],
      [
        0, -0.1332568242984661, 0.1332568242984661, -0.26413568097034495, 0.26413568097034495, -0.3903010380302908, 0.3903010380302908, -0.5095014778460075, 0.5095014778460075, -0.6196098757636461, 0.6196098757636461, -0.7186613631319502,
        0.7186613631319502, -0.8048884016188399, 0.8048884016188399, -0.8767523582704416, 0.8767523582704416, -0.9329710868260161, 0.9329710868260161, -0.9725424712181152, 0.9725424712181152, -0.9947693349975522, 0.9947693349975522,
      ],
      [
        -0.06405689286260563, 0.06405689286260563, -0.1911188674736163, 0.1911188674736163, -0.3150426796961634, 0.3150426796961634, -0.4337935076260451, 0.4337935076260451, -0.5454214713888396, 0.5454214713888396, -0.6480936519369755,
        0.6480936519369755, -0.7401241915785544, 0.7401241915785544, -0.820001985973903, 0.820001985973903, -0.8864155270044011, 0.8864155270044011, -0.9382745520027328, 0.9382745520027328, -0.9747285559713095, 0.9747285559713095,
    ...
    ne = [
      ...
      [
        0.24914704581340277, 0.24914704581340277, 0.2334925365383548, 0.2334925365383548, 0.20316742672306592, 0.20316742672306592, 0.16007832854334622, 0.16007832854334622, 0.10693932599531843, 0.10693932599531843, 0.04717533638651183,
        0.04717533638651183,
      ],
      [
        0.2325515532308739, 0.22628318026289723, 0.22628318026289723, 0.2078160475368885, 0.2078160475368885, 0.17814598076194574, 0.17814598076194574, 0.13887351021978725, 0.13887351021978725, 0.09212149983772845, 0.09212149983772845,
        0.04048400476531588, 0.04048400476531588,
      ],
      [
        0.2152638534631578, 0.2152638534631578, 0.2051984637212956, 0.2051984637212956, 0.18553839747793782, 0.18553839747793782, 0.15720316715819355, 0.15720316715819355, 0.12151857068790319, 0.12151857068790319, 0.08015808715976021,
        0.08015808715976021, 0.03511946033175186, 0.03511946033175186,
      ],
      [
        0.2025782419255613, 0.19843148532711158, 0.19843148532711158, 0.1861610000155622, 0.1861610000155622, 0.16626920581699392, 0.16626920581699392, 0.13957067792615432, 0.13957067792615432, 0.10715922046717194, 0.10715922046717194,
        0.07036604748810812, 0.07036604748810812, 0.03075324199611727, 0.03075324199611727,
      ],
      [
        0.1894506104550685, 0.1894506104550685, 0.18260341504492358, 0.18260341504492358, 0.16915651939500254, 0.16915651939500254, 0.14959598881657674, 0.14959598881657674, 0.12462897125553388, 0.12462897125553388, 0.09515851168249279,
        0.09515851168249279, 0.062253523938647894, 0.062253523938647894, 0.027152459411754096, 0.027152459411754096,
      ],
      [
        0.17944647035620653, 0.17656270536699264, 0.17656270536699264, 0.16800410215645004, 0.16800410215645004, 0.15404576107681028, 0.15404576107681028, 0.13513636846852548, 0.13513636846852548, 0.11188384719340397, 0.11188384719340397,
        0.08503614831717918, 0.08503614831717918, 0.0554595293739872, 0.0554595293739872, 0.02414830286854793, 0.02414830286854793,
      ],
      [
        0.1691423829631436, 0.1691423829631436, 0.16427648374583273, 0.16427648374583273, 0.15468467512626524, 0.15468467512626524, 0.14064291467065065, 0.14064291467065065, 0.12255520671147846, 0.12255520671147846, 0.10094204410628717,
        0.10094204410628717, 0.07642573025488905, 0.07642573025488905, 0.0497145488949698, 0.0497145488949698, 0.02161601352648331, 0.02161601352648331,
      ],
      [
        0.1610544498487837, 0.15896884339395434, 0.15896884339395434, 0.15276604206585967, 0.15276604206585967, 0.1426067021736066, 0.1426067021736066, 0.12875396253933621, 0.12875396253933621, 0.11156664554733399, 0.11156664554733399,
        0.09149002162245, 0.09149002162245, 0.06904454273764123, 0.06904454273764123, 0.0448142267656996, 0.0448142267656996, 0.019461788229726478, 0.019461788229726478,
      ],
      [
        0.15275338713072584, 0.15275338713072584, 0.14917298647260374, 0.14917298647260374, 0.14209610931838204, 0.14209610931838204, 0.13168863844917664, 0.13168863844917664, 0.11819453196151841, 0.11819453196151841, 0.10193011981724044,
        0.10193011981724044, 0.08327674157670475, 0.08327674157670475, 0.06267204833410907, 0.06267204833410907, 0.04060142980038694, 0.04060142980038694, 0.017614007139152118, 0.017614007139152118,
      ],
      [
        0.14608113364969041, 0.14452440398997005, 0.14452440398997005, 0.13988739479107315, 0.13988739479107315, 0.13226893863333747, 0.13226893863333747, 0.12183141605372853, 0.12183141605372853, 0.10879729916714838, 0.10879729916714838,
        0.09344442345603386, 0.09344442345603386, 0.0761001136283793, 0.0761001136283793, 0.057134425426857205, 0.057134425426857205, 0.036953789770852494, 0.036953789770852494, 0.016017228257774335, 0.016017228257774335,
      ],
      [
        0.13925187285563198, 0.13925187285563198, 0.13654149834601517, 0.13654149834601517, 0.13117350478706238, 0.13117350478706238, 0.12325237681051242, 0.12325237681051242, 0.11293229608053922, 0.11293229608053922, 0.10041414444288096,
        0.10041414444288096, 0.08594160621706773, 0.08594160621706773, 0.06979646842452049, 0.06979646842452049, 0.052293335152683286, 0.052293335152683286, 0.03377490158481415, 0.03377490158481415, 0.0146279952982722, 0.0146279952982722,
      ],
      [
        0.13365457218610619, 0.1324620394046966, 0.1324620394046966, 0.12890572218808216, 0.12890572218808216, 0.12304908430672953, 0.12304908430672953, 0.11499664022241136, 0.11499664022241136, 0.10489209146454141, 0.10489209146454141,
        0.09291576606003515, 0.09291576606003515, 0.07928141177671895, 0.07928141177671895, 0.06423242140852585, 0.06423242140852585, 0.04803767173108467, 0.04803767173108467, 0.030988005856979445, 0.030988005856979445, 0.013411859487141771,
        0.013411859487141771,
      ],
      [
        0.12793819534675216, 0.12793819534675216, 0.1258374563468283, 0.1258374563468283, 0.12167047292780339, 0.12167047292780339, 0.1155056680537256, 0.1155056680537256, 0.10744427011596563, 0.10744427011596563, 0.09761865210411388,
        0.09761865210411388, 0.08619016153195327, 0.08619016153195327, 0.0733464814110803, 0.0733464814110803, 0.05929858491543678, 0.05929858491543678, 0.04427743881741981, 0.04427743881741981, 0.028531388628933663, 0.028531388628933663,
  ...
  class ge extends Nt {
      ...
      switch (n.command) {
        ...
        case "C":
          return ge.getPointOnCubicBezier(
            ce(t, ge.getPathLength(e), (t) => oe([n.start.x, s[0], s[2], s[4]], [n.start.y, s[1], s[3], s[5]], t)),
            n.start.x,
            n.start.y,
            s[0],
            s[1],
        ...
        case "Q":
          return ge.getPointOnQuadraticBezier(
            ce(t, ge.getPathLength(e), (t) => he([n.start.x, s[0], s[2]], [n.start.y, s[1], s[3]], t)),
            n.start.x,
            n.start.y,
            s[0],
            s[1],
    ...
    static getPointOnLine(t, e, i, r, a, n, s) {
      ...
      const h = (a - i) / (r - e),
        l = Math.sqrt((t * t) / (1 + h * h)) * (r < e ? -1 : 1),
        d = h * l;
      if (Math.abs(s - i - h * (n - e)) < 1e-10) return { x: n + l, y: s + d };
      const c = ((n - e) * (r - e) + (s - i) * (a - i)) / (o * o),
        g = e + c * (r - e),
        u = i + c * (a - i),
        f = this.getLineLength(n, s, g, u),
        p = Math.sqrt(t * t - f * f),
        ...
        for (; u.length > 0 && !isNaN(u[0]); ) {
          ...
          switch (g) {
            ...
            case "c":
              ...
              break;
            case "S":
              (_ = h), (y = l), "C" === (m = s[s.length - 1]).command && ((_ = h + (h - m.points[2])), (y = l + (l - m.points[3]))), A.push(_, y, u.shift(), u.shift()), (h = u.shift()), (l = u.shift()), (T = "C"), A.push(h, l);
              break;
            case "s":
              (_ = h), (y = l), "C" === (m = s[s.length - 1]).command && ((_ = h + (h - m.points[2])), (y = l + (l - m.points[3]))), A.push(_, y, h + u.shift(), l + u.shift()), (h += u.shift()), (l += u.shift()), (T = "C"), A.push(h, l);
              break;
            case "Q":
            ...
            case "q":
              ...
              break;
            case "T":
              (_ = h), (y = l), "Q" === (m = s[s.length - 1]).command && ((_ = h + (h - m.points[0])), (y = l + (l - m.points[1]))), (h = u.shift()), (l = u.shift()), (T = "Q"), A.push(_, y, h, l);
              break;
            case "t":
              (_ = h), (y = l), "Q" === (m = s[s.length - 1]).command && ((_ = h + (h - m.points[0])), (y = l + (l - m.points[1]))), (h += u.shift()), (l += u.shift()), (T = "Q"), A.push(_, y, h, l);
              break;
            case "A":
              (x = u.shift()), (b = u.shift()), (S = u.shift()), (w = u.shift()), (C = u.shift()), (P = h), (k = l), (h = u.shift()), (l = u.shift()), (T = "A"), (A = this.convertEndpointToCenterParameterization(P, k, h, l, w, C, x, b, S));
              break;
            case "a":
              (x = u.shift()), (b = u.shift()), (S = u.shift()), (w = u.shift()), (C = u.shift()), (P = h), (k = l), (h += u.shift()), (l += u.shift()), (T = "A"), (A = this.convertEndpointToCenterParameterization(P, k, h, l, w, C, x, b, S));
          }
  ...
  class ue extends re {
    _sceneFunc(t) {
      ...
      var l = (Math.atan2(s, n) + e) % e,
        d = this.pointerWidth();
      this.pointerAtEnding() && (t.save(), t.beginPath(), t.translate(i[h - 2], i[h - 1]), t.rotate(l), t.moveTo(0, 0), t.lineTo(-o, d / 2), t.lineTo(-o, -d / 2), t.closePath(), t.restore(), this.__fillStroke(t)),
  ...
  class Ce extends Nt {
    _sceneFunc(t) {
      ...
      let o = 0,
        ...
        l = 0,
        d = 0;
      "number" == typeof s ? (o = h = l = d = Math.min(s, e / 2, i / 2)) : ((o = Math.min(s[0] || 0, e / 2, i / 2)), (h = Math.min(s[1] || 0, e / 2, i / 2)), (d = Math.min(s[2] || 0, e / 2, i / 2)), (l = Math.min(s[3] || 0, e / 2, i / 2))),
        t.beginPath(),
        t.moveTo(o, 0),
        r === _e && (t.lineTo((e - a) / 2, 0), t.lineTo(e / 2, -1 * n), t.lineTo((e + a) / 2, 0)),
        t.lineTo(e - h, 0),
        t.arc(e - h, h, h, (3 * Math.PI) / 2, 0, !1),
        r === ye && (t.lineTo(e, (i - n) / 2), t.lineTo(e + a, i / 2), t.lineTo(e, (i + n) / 2)),
        t.lineTo(e, i - d),
        t.arc(e - d, i - d, d, 0, Math.PI / 2, !1),
        r === xe && (t.lineTo((e + a) / 2, i), t.lineTo(e / 2, i + n), t.lineTo((e - a) / 2, i)),
        t.lineTo(l, i),
        t.arc(l, i - l, l, Math.PI / 2, Math.PI, !1),
        r === be && (t.lineTo(0, (i + n) / 2), t.lineTo(-1 * a, i / 2), t.lineTo(0, (i - n) / 2)),
        t.lineTo(0, o),
    ...
    getSelfRect() {
      var t = 0,
        ...
        n = this.width(),
        s = this.height();
      return a === _e ? ((e -= r), (s += r)) : a === xe ? (s += r) : a === be ? ((t -= 1.5 * i), (n += i)) : a === ye && (n += 1.5 * i), { x: t, y: e, width: n, height: s };
    }
  }
  ...
  class Ae extends Nt {
    _sceneFunc(t) {
      t.beginPath(), t.arc(0, 0, this.innerRadius(), 0, Te, !1), t.moveTo(this.outerRadius(), 0), t.arc(0, 0, this.outerRadius(), Te, 0, !0), t.closePath(), t.fillStrokeShape(this);
    }
    getWidth() {
      return 2 * this.outerRadius();
    }
  ...
  (Ae.prototype.className = "Ring"), (Ae.prototype._centroid = !0), (Ae.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"]), r(Ae), w.addGetterSetter(Ae, "innerRadius", 0, p()), w.addGetterSetter(Ae, "outerRadius", 0, p());
  class Me extends Nt {
    constructor(t) {
      super(t),
        (this._updated = !0),
  ...
  function Re(t) {
    return [...t].reduce(
      (t, e, i, r) => (
        /\p{Emoji_Modifier_Base}\p{Emoji_Modifier}?(?:\u200D\p{Emoji_Presentation})+/u.test(e)
          ? t.push(e)
          : /\p{Regional_Indicator}{2}/u.test(e + (r[i + 1] || ""))
          ? t.push(e + r[i + 1])
    ...
    _sceneFunc(t) {
      ...
      if (this.text()) {
        var a,
          ...
          v = -1 !== p.indexOf("underline"),
          m = -1 !== p.indexOf("line-through");
        l = l === Le ? t.direction : l;
        var _ = o / 2,
          y = Fe;
        if (i._fixTextRendering) {
          var x = this.measureSize("M");
          (y = "alphabetic"), (_ = (x.fontBoundingBoxAscent - x.fontBoundingBoxDescent) / 2 + o / 2);
        }
        var b = 0,
          S = 0;
        for (
          "rtl" === l && t.setAttr("direction", l),
            ...
            t.setAttr("textBaseline", y),
            t.setAttr("textAlign", Oe),
            h === Fe ? (d = (this.getHeight() - r * o - 2 * n) / 2) : "bottom" === h && (d = this.getHeight() - r * o - 2 * n),
            t.translate(n, d + n),
            a = 0;
          a < r;
          a++
          ...
          var w,
            ...
            A = k.width,
            M = k.lastInParagraph;
          if ((t.save(), "right" === c ? (b += g - A - 2 * n) : "center" === c && (b += (g - A - 2 * n) / 2), v)) {
            t.save(), t.beginPath();
            const e = b,
              r = _ + S + (i._fixTextRendering ? Math.round(s / 4) : Math.round(s / 2));
            t.moveTo(e, r), (C = 0 === (w = T.split(" ").length - 1)), (P = c !== Ie || M ? A : g - 2 * n), t.lineTo(e + Math.round(P), r), (t.lineWidth = s / 15);
            const a = this._getLinearGradient();
            (t.strokeStyle = a || f), t.stroke(), t.restore();
          }
          if (m) {
            t.save(), t.beginPath();
            let e = i._fixTextRendering ? -Math.round(s / 4) : 0;
            t.moveTo(b, _ + S + e), (C = 0 === (w = T.split(" ").length - 1)), (P = c === Ie && M && !C ? g - 2 * n : A), t.lineTo(b + Math.round(P), _ + S + e), (t.lineWidth = s / 15);
            const r = this._getLinearGradient();
            (t.strokeStyle = r || f), t.stroke(), t.restore();
          }
          if ("rtl" === l || (0 === u && c !== Ie)) 0 !== u && t.setAttr("letterSpacing", `${u}px`), (this._partialTextX = b), (this._partialTextY = _ + S), (this._partialText = T), t.fillStrokeShape(this);
          else {
            w = T.split(" ").length - 1;
            for (var G = Re(T), R = 0; R < G.length; R++) {
              var E = G[R];
              " " !== E || M || c !== Ie || (b += (g - 2 * n - A) / w), (this._partialTextX = b), (this._partialTextY = _ + S), (this._partialText = E), t.fillStrokeShape(this), (b += this.measureSize(E).width + u);
            }
          }
          t.restore(), r > 1 && (_ += o);
        }
        ...
        if (s && y > l)
          for (; _.length > 0; ) {
            ...
            if (u) {
              var T,
                A = _[S.length];
              (T = (A === Ne || "-" === A) && w <= l ? S.length : Math.max(S.lastIndexOf(Ne), S.lastIndexOf("-")) + 1) > 0 && ((x = T), (S = S.slice(0, x)), (w = this._getTextWidth(S)));
            }
  ...
  (Xe.prototype._fillFunc = function (t) {
    ...
    r(Xe),
    w.overWriteSetter(Xe, "width", m()),
    w.overWriteSetter(Xe, "height", m()),
    w.addGetterSetter(Xe, "direction", Le),
    w.addGetterSetter(Xe, "fontFamily", "Arial"),
    w.addGetterSetter(Xe, "fontSize", 12, p()),
    w.addGetterSetter(Xe, "fontStyle", Be),
    w.addGetterSetter(Xe, "fontVariant", Be),
    w.addGetterSetter(Xe, "padding", 0, p()),
    w.addGetterSetter(Xe, "align", Oe),
  ...
  class Ve extends Nt {
    ...
    _setTextData() {
      ...
      for (var l = 0; l < o.length; l++) {
        ...
        this.glyphInfo.push({ transposeX: g.x, transposeY: g.y, text: o[l], rotation: u, p0: t, p1: s }), (h += e);
      }
    }
    getSelfRect() {
  ...
  (Ve.prototype._fillFunc = qe),
    ...
    w.addGetterSetter(Ve, "textDecoration", null),
    w.addGetterSetter(Ve, "kerningFunc", null);
  var Ke = "tr-konva",
    Qe = [
      "resizeEnabledChange",
    ...
    Ze = { "top-left": -45, "top-center": 0, "top-right": 45, "middle-right": -90, "middle-left": 90, "bottom-left": -135, "bottom-center": 180, "bottom-right": 135 };
  ...
  function ri(t, e) {
    const i = (function (t) {
      return { x: t.x + (t.width / 2) * Math.cos(t.rotation) + (t.height / 2) * Math.sin(-t.rotation), y: t.y + (t.height / 2) * Math.cos(t.rotation) + (t.width / 2) * Math.sin(t.rotation) };
    })(t);
    return ii(t, e, i);
  }
  let ai = 0;
  class ni extends Xt {
    ...
    __getNodeShape(t, e = this.rotation(), r) {
      ...
      return ii({ x: s.x + o * Math.cos(l) + h * Math.sin(-l), y: s.y + h * Math.cos(l) + o * Math.sin(l), width: a.width * n.x, height: a.height * n.y, rotation: l }, -i.getAngle(e), { x: 0, y: 0 });
    }
    __getNodeRect() {
    ...
    _createAnchor(t) {
      var e = new Pe({ stroke: "rgb(0, 161, 255)", fill: "white", strokeWidth: 1, name: t + " _anchor", dragDistance: 0, draggable: !0, hitStrokeWidth: ti ? 10 : "auto" }),
        r = this;
        ...
        e.on("mouseenter", () => {
          var r = i.getAngle(this.rotation()),
            ...
            n = (function (t, e, i) {
              ...
              return g._inRange(r, 337.5, 360) || g._inRange(r, 0, 22.5)
                ? "ns-resize"
                : g._inRange(r, 22.5, 67.5)
                ? "nesw-resize"
                : g._inRange(r, 67.5, 112.5)
                ? "ew-resize"
                : g._inRange(r, 112.5, 157.5)
                ? "nwse-resize"
                : g._inRange(r, 157.5, 202.5)
                ? "ns-resize"
                : g._inRange(r, 202.5, 247.5)
                ? "nesw-resize"
                : g._inRange(r, 247.5, 292.5)
                ? "ew-resize"
                : g._inRange(r, 292.5, 337.5)
                ? "nwse-resize"
                : (g.error("Transformer has unknown angle for cursor detection: " + r), "pointer");
            })(t, r, a);
      ...
      var t = new Nt({
        ...
        sceneFunc(t, e) {
          ...
          t.beginPath(),
            ...
            i.rotateEnabled() && i.rotateLineVisible() && t.lineTo(e.width() / 2, -i.rotateAnchorOffset() * g._sign(e.height()) - r),
            t.fillStrokeShape(e);
        },
        hitFunc: (t, e) => {
      ...
      if (l.x !== d.x || l.y !== d.y)
        if ("rotater" !== this._movingAnchorName) {
          ...
          if ("top-left" === this._movingAnchorName) {
            if (c) {
              var f = u ? { x: this.width() / 2, y: this.height() / 2 } : { x: this.findOne(".bottom-right").x(), y: this.findOne(".bottom-right").y() };
            ...
            if (c) {
              f = u ? { x: this.width() / 2, y: this.height() / 2 } : { x: this.findOne(".bottom-left").x(), y: this.findOne(".bottom-left").y() };
            ...
            if (c) {
              f = u ? { x: this.width() / 2, y: this.height() / 2 } : { x: this.findOne(".top-right").x(), y: this.findOne(".top-right").y() };
            ...
            if (c) {
              f = u ? { x: this.width() / 2, y: this.height() / 2 } : { x: this.findOne(".top-left").x(), y: this.findOne(".top-left").y() };
          ...
          this._fitNodesInto({ x: e, y: r, width: P, height: k, rotation: i.getAngle(this.rotation()) }, t);
        } else {
      ...
      if (this._transforming) {
        ...
        ai--,
          ...
          i &&
            this._nodes.forEach((e) => {
              var i;
              e._fire("transformend", { evt: t, target: e }), null === (i = e.getLayer()) || void 0 === i || i.batchDraw();
            }),
          (this._movingAnchorName = null);
      }
    }
    _fitNodesInto(t, e) {
      ...
      if ((n.rotate(i.getAngle(this.rotation())), this._movingAnchorName && t.width < 0 && this._movingAnchorName.indexOf("left") >= 0)) {
        const e = n.point({ x: 2 * -this.padding(), y: 0 });
      ...
      if (this._movingAnchorName && t.height < 0 && this._movingAnchorName.indexOf("top") >= 0) {
        const e = n.point({ x: 0, y: 2 * -this.padding() });
      ...
      this._nodes.forEach((t) => {
        ...
        const n = new a();
        n.multiply(i.copy().invert()).multiply(c).multiply(i).multiply(r);
        const s = n.decompose();
    ...
    update() {
      ...
      h.forEach((t) => {
        t.setAttrs({ width: o, height: o, offsetX: o / 2, offsetY: o / 2, stroke: this.anchorStroke(), strokeWidth: this.anchorStrokeWidth(), fill: this.anchorFill(), cornerRadius: this.anchorCornerRadius() });
      }),
        ...
        this._batchChangeChild(".bottom-right", { x: i, y: r, offsetX: o / 2 - s, offsetY: o / 2 - s, visible: n && a.indexOf("bottom-right") >= 0 }),
        this._batchChangeChild(".rotater", { x: i / 2, y: -this.rotateAnchorOffset() * g._sign(r) - s, visible: this.rotateEnabled() }),
        this._batchChangeChild(".back", { width: i, height: r, visible: this.borderEnabled(), stroke: this.borderStroke(), strokeWidth: this.borderStrokeWidth(), dash: this.borderDash(), x: 0, y: 0 });
  ...
  (ni.isTransforming = () => ai > 0),
    (ni.prototype.className = "Transformer"),
    r(ni),
    w.addGetterSetter(ni, "enabledAnchors", ei, function (t) {
      return (
    ...
    w.addGetterSetter(ni, "flipEnabled", !0, x()),
    w.addGetterSetter(ni, "resizeEnabled", !0),
    w.addGetterSetter(ni, "anchorSize", 10, p()),
    w.addGetterSetter(ni, "rotateEnabled", !0),
    w.addGetterSetter(ni, "rotateLineVisible", !0),
    w.addGetterSetter(ni, "rotationSnaps", []),
    w.addGetterSetter(ni, "rotateAnchorOffset", 50, p()),
    w.addGetterSetter(ni, "rotateAnchorCursor", "crosshair"),
    w.addGetterSetter(ni, "rotationSnapTolerance", 5, p()),
    w.addGetterSetter(ni, "borderEnabled", !0),
    w.addGetterSetter(ni, "anchorStroke", "rgb(0, 161, 255)"),
    w.addGetterSetter(ni, "anchorStrokeWidth", 1, p()),
    w.addGetterSetter(ni, "anchorFill", "white"),
    w.addGetterSetter(ni, "anchorCornerRadius", 0, p()),
    w.addGetterSetter(ni, "borderStroke", "rgb(0, 161, 255)"),
    w.addGetterSetter(ni, "borderStrokeWidth", 1, p()),
    w.addGetterSetter(ni, "borderDash"),
    w.addGetterSetter(ni, "keepRatio", !0),
    w.addGetterSetter(ni, "shiftBehavior", "default"),
    w.addGetterSetter(ni, "centeredScaling", !1),
    w.addGetterSetter(ni, "ignoreStroke", !1),
    w.addGetterSetter(ni, "padding", 0, p()),
    w.addGetterSetter(ni, "node"),
    w.addGetterSetter(ni, "nodes"),
    w.addGetterSetter(ni, "boundBoxFunc"),
    w.addGetterSetter(ni, "anchorDragBoundFunc"),
    w.addGetterSetter(ni, "anchorStyleFunc"),
    w.addGetterSetter(ni, "shouldOverdrawWholeArea", !1),
    w.addGetterSetter(ni, "useSingleNodeRotation", !0),
    w.backCompat(ni, { lineEnabled: "borderEnabled", rotateHandlerOffset: "rotateAnchorOffset", enabledHandlers: "enabledAnchors" });
  class si extends Nt {
    _sceneFunc(t) {
  ...
  (si.prototype.className = "Wedge"),
    ...
    r(si),
    w.addGetterSetter(si, "radius", 0, p()),
    w.addGetterSetter(si, "angle", 0, p()),
    w.addGetterSetter(si, "clockwise", !1),
    w.backCompat(si, { angleDeg: "angle", getAngleDeg: "getAngle", setAngleDeg: "setAngle" });
  var hi = [
      512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437,
      420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437,
      428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389,
      383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437,
      433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280,
      278, 275, 273, 271, 269, 267, 265, 263, 261, 259,
    ],
    li = [
      9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20,
      20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22,
      22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24,
  ...
  w.addGetterSetter(V, "embossStrength", 0.5, p(), w.afterSetFilter),
    ...
    w.addGetterSetter(V, "embossDirection", "top-left", null, w.afterSetFilter),
    w.addGetterSetter(V, "embossBlend", !1, null, w.afterSetFilter);
    ...
    Filters: {
        ...
        e > 0 &&
          (function (t, e) {
            var i,
              ...
              N = hi[e],
              H = li[e];
            for (a = 1; a < M; a++) (O = O.next = new oi()), a === E && (I = O);
            for (O.next = L, h = o = 0, r = 0; r < A; r++) {
              for (m = _ = y = x = l = d = c = g = 0, u = E * (b = k[o]), f = E * (S = k[o + 1]), p = E * (w = k[o + 2]), v = E * (C = k[o + 3]), l += D * b, d += D * S, c += D * w, g += D * C, O = L, a = 0; a < E; a++)
                (O.r = b), (O.g = S), (O.b = w), (O.a = C), (O = O.next);
              for (a = 1; a < E; a++)
                (n = o + ((G < a ? G : a) << 2)), (l += (O.r = b = k[n]) * (P = E - a)), (d += (O.g = S = k[n + 1]) * P), (c += (O.b = w = k[n + 2]) * P), (g += (O.a = C = k[n + 3]) * P), (m += b), (_ += S), (y += w), (x += C), (O = O.next);
              for (F = L, B = I, i = 0; i < T; i++)
                (k[o + 3] = C = (g * N) >> H),
                  0 !== C ? ((C = 255 / C), (k[o] = ((l * N) >> H) * C), (k[o + 1] = ((d * N) >> H) * C), (k[o + 2] = ((c * N) >> H) * C)) : (k[o] = k[o + 1] = k[o + 2] = 0),
                  (l -= u),
                  (d -= f),
                  (c -= p),
                  (g -= v),
            ...
            for (i = 0; i < T; i++) {
              for (_ = y = x = m = d = c = g = l = 0, u = E * (b = k[(o = i << 2)]), f = E * (S = k[o + 1]), p = E * (w = k[o + 2]), v = E * (C = k[o + 3]), l += D * b, d += D * S, c += D * w, g += D * C, O = L, a = 0; a < E; a++)
                (O.r = b), (O.g = S), (O.b = w), (O.a = C), (O = O.next);
              for (s = T, a = 1; a <= e; a++)
                (o = (s + i) << 2), (l += (O.r = b = k[o]) * (P = E - a)), (d += (O.g = S = k[o + 1]) * P), (c += (O.b = w = k[o + 2]) * P), (g += (O.a = C = k[o + 3]) * P), (m += b), (_ += S), (y += w), (x += C), (O = O.next), a < R && (s += T);
              for (o = i, F = L, B = I, r = 0; r < A; r++)
                (k[3 + (n = o << 2)] = C = (g * N) >> H),
                  C > 0 ? ((C = 255 / C), (k[n] = ((l * N) >> H) * C), (k[n + 1] = ((d * N) >> H) * C), (k[n + 2] = ((c * N) >> H) * C)) : (k[n] = k[n + 1] = k[n + 2] = 0),
                  (l -= u),
                  (d -= f),
                  (c -= p),
                  (g -= v),
          ...
          do {
            ...
            if (((b > 0 ? b : -b) > C && (w = b), (S > 0 ? S : -S) > C && (w = S), (w *= e), a)) {
              var P = o[m] + w,
                k = o[m + 1] + w,
                T = o[m + 2] + w;
              (o[m] = P > 255 ? 255 : P < 0 ? 0 : P), (o[m + 1] = k > 255 ? 255 : k < 0 ? 0 : k), (o[m + 2] = T > 255 ? 255 : T < 0 ? 0 : T);
            } else {
              var A = i - w;
        ...
        if (0 !== u) {
          ...
          for (
            h === o && ((h = 255), (o = 0)),
              ...
              g === c && ((g = 255), (c = 0)),
              u > 0
                ? ((p = h + u * (255 - h)), (v = o - u * (o - 0)), (_ = d + u * (255 - d)), (y = l - u * (l - 0)), (b = g + u * (255 - g)), (S = c - u * (c - 0)))
                : ((p = h + u * (h - (f = 0.5 * (h + o)))), (v = o + u * (o - f)), (_ = d + u * (d - (m = 0.5 * (d + l)))), (y = l + u * (l - m)), (b = g + u * (g - (x = 0.5 * (g + c)))), (S = c + u * (c - x))),
              a = 0;
            a < s;
            a += 4
          )
            (n[a + 0] = di(n[a + 0], o, h, v, p)), (n[a + 1] = di(n[a + 1], l, d, y, _)), (n[a + 2] = di(n[a + 2], c, g, S, b));
        }
      },
      ...
      Kaleidoscope: function (t) {
        ...
        if (!(u < 1)) {
          ...
          for (p + _ > d && ((x = y), (b = 0), (S = -1)), i = 0; i < c; i += 1)
            for (e = x; e !== b; e += S)
              (h = 4 * (d * i + (Math.round(e + p) % d))), (a = m.data[h + 0]), (n = m.data[h + 1]), (s = m.data[h + 2]), (o = m.data[h + 3]), (l = 4 * (d * i + e)), (m.data[l + 0] = a), (m.data[l + 1] = n), (m.data[l + 2] = s), (m.data[l + 3] = o);
          for (i = 0; i < c; i += 1)
            for (y = Math.floor(_), r = 0; r < u; r += 1) {
              for (e = 0; e < y + 1; e += 1)
                (h = 4 * (d * i + e)), (a = m.data[h + 0]), (n = m.data[h + 1]), (s = m.data[h + 2]), (o = m.data[h + 3]), (l = 4 * (d * i + 2 * y - e - 1)), (m.data[l + 0] = a), (m.data[l + 1] = n), (m.data[l + 2] = s), (m.data[l + 3] = o);
              y *= 2;
            }
          !(function (t, e, i) {
            var r,
            ...
            for (a = 0; a < c; a += 1)
              for (n = 0; n < g; n += 1)
                (s = a - u),
                  ...
                  (b = ((b = ((180 * Math.atan2(o, s)) / Math.PI + 360 + 0) % 360) * C) / 360),
                  (S = Math.floor(b)),
      ...
      Mask: function (t) {
        var e = (function (t, e) {
          var i = ci(t, 0, 0),
            r = ci(t, t.width - 1, 0),
            a = ci(t, 0, t.height - 1),
            n = ci(t, t.width - 1, t.height - 1),
            s = e || 10;
          if (gi(i, r) < s && gi(r, n) < s && gi(n, a) < s && gi(a, i) < s) {
            for (
              var o = (function (t) {
              ...
              var d = gi(o, [t.data[4 * l], t.data[4 * l + 1], t.data[4 * l + 2]]);
              h[l] = d < s ? 0 : 255;
            }
            return h;
          }
          ...
          for (u = 0; u < y; u += 1)
            for (f = 0; f < x; f += 1) {
              for (a = 0, n = 0, s = 0, o = 0, l = (h = u * v) + v, c = (d = f * v) + v, p = 0, e = h; e < l; e += 1)
                if (!(e >= m)) for (i = d; i < c; i += 1) i >= _ || ((a += b[(r = 4 * (m * i + e)) + 0]), (n += b[r + 1]), (s += b[r + 2]), (o += b[r + 3]), (p += 1));
              for (a /= p, n /= p, s /= p, o /= p, e = h; e < l; e += 1) if (!(e >= m)) for (i = d; i < c; i += 1) i >= _ || ((b[(r = 4 * (m * i + e)) + 0] = a), (b[r + 1] = n), (b[r + 2] = s), (b[r + 3] = o));
            }
      },
      ...
      RGB: function (t) {
        var e,
          ...
          s = this.green(),
          o = this.blue();
        for (e = 0; e < a; e += 4) (i = (0.34 * r[e] + 0.5 * r[e + 1] + 0.16 * r[e + 2]) / 255), (r[e] = i * n), (r[e + 1] = i * s), (r[e + 2] = i * o), (r[e + 3] = r[e + 3]);
      },
      RGBA: function (t) {
        var e,
          i,
      ...
      Sepia: function (t) {
        var e,
          ...
          s = n.length;
        for (e = 0; e < s; e += 4)
          (i = n[e + 0]), (r = n[e + 1]), (a = n[e + 2]), (n[e + 0] = Math.min(255, 0.393 * i + 0.769 * r + 0.189 * a)), (n[e + 1] = Math.min(255, 0.349 * i + 0.686 * r + 0.168 * a)), (n[e + 2] = Math.min(255, 0.272 * i + 0.534 * r + 0.131 * a));
      },
      Solarize: function (t) {
        var e = t.data,
          i = t.width,
